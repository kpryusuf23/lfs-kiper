...
openGlobalButton( "önemli",40,0,80,5,0,-1,35,"^T^1Duyuru Bölümü:^7Sunucumuzda CRASH^1/^7KÜFÜR^1/^7SPAM ^1YASAKTIR!" . "%at%^1Duyuru Bölümü:^7Sunucumuzda CRASH^1/^7KÜFÜR^1/^7SPAM ^1YASAKTIR!" . "%at%^1Duyuru Bölümü:^7Sunucumuzda CRASH^1/^7KÜFÜR^1/^7SPAM ^1YASAKTIR!" . "%at%^1Duyuru Bölümü:^7Sunucumuzda CRASH^1/^7KÜFÜR^1/^7SPAM ^1YASAKTIR!" . "%at%^1Duyuru Bölümü:^7Sunucumuzda CRASH^1/^7KÜFÜR^1/^7SPAM ^1YASAKTIR!" . "%at%^T^7İyi Oyunlar Dileriz." . "%at%^T^7İyi Oyunlar Dileriz." . "%at%^T^7İyi Oyunlar Dileriz." . "%at%^T^7İyi Oyunlar Dileriz." . "%at%^T^7İyi Oyunlar Dileriz." . "%at%^T^7İyi Oyunlar Dileriz." . "%at%^T^7İyi Oyunlar Dileriz." . "%at%^T^7İyi Oyunlar Dileriz.");
openGlobalButton( "pist",120,0,60,5,6,-1,35,"^T^1LFS ^7TÜRKİYE ^3DRİFT ^7Bizi Tercih Ettiğiniz İçin Teşekkür Ederiz.");
openGlobalButton( "onemli",35,5,50,5,0,-1,32,"^T^1Adminlik ^7Alımları ^4Discord ^7Üzerinden Başlamıştır!");
openGlobalButton( "aralik",85,5,25,5,0,-1,32,"^1Aktif oyuncu ^0: ^7". GetLapperVar( "numConns" ),"" );
openGlobalButton( "aarik",110,5,20,5,0,-1,32,"^T^7Komutlar^1:^1!dc" . "%at%^T^7Komutlar^1:^1!dc" . "%at%^T^7Komutlar^1:^1!sigara");
openGlobalButton( "admins_pre",130,5,35,5,0,-1,32,"^7Aktif Admin ^0:^7 " . $admin_name . " " . $ );
openGlobalButton( "admin_present",0,196,21,4,5,-1,97,"^T^1İnstagram:^7kiper.yusuf23");
